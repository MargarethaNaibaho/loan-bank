package com.enigmabank.enigmabanking.security;
...
public class JwtUtil {
    @Value("${app.enigmabanking.jwt-secret}")
    private String jwtSecret;

    @Value("${app.enigmabanking.app-name}")
    private String appName;

    @Value("${app.enigmabanking.jwtExpirationTimeInSecond}")
